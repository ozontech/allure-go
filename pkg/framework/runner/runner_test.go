...
//
//	r := runner{tests: make(map[string]*testFunc), internalT: newInternalTMock(constants.BeforeEachContextName)}
//
...
//	defer os.RemoveAll(allureDir)
//
//	r := runner{tests: make(map[string]*testFunc), internalT: newInternalTMock(constants.AfterEachContextName)}
...
//	defer os.RemoveAll(allureDir)
//
//	r := runner{tests: make(map[string]*testFunc), internalT: newInternalTMock(constants.BeforeAllContextName)}
...
//	defer os.RemoveAll(allureDir)
//
//	r := runner{tests: make(map[string]*testFunc), internalT: newInternalTMock(constants.AfterAllContextName)}
