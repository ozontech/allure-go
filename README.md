...
Have a look at [here](./examples/suite_demo/new_parameterized_test.go) or [here](#).

:information_source: you need just create parameter field in suite struct and add argument to the test signature (cool, hah?).
